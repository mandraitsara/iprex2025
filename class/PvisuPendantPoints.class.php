...
class PvisuPendantPoints {
	...
	public function getId_pvisu_pendant() {
		return $this->id_pvisu_pendant;
	}
	...
	public function setId_pvisu_pendant($id_pvisu_pendant) {
		$this->id_pvisu_pendant = (int)$id_pvisu_pendant;
		Outils::setAttributs('id_pvisu_pendant',$this);
	}
