...
class Validation {
	...
	protected	$id,
				...
				$type,
				$id_liaison,
				$id_liaison_negoce,				// ID de la ligne à valider dans la table de liason
	...
	public function getId_liaison_negoce() {
		return $this->id_liaison_negoce;
	}
...
/*##### SETTERS #####*/
	...
	public function setId_liaison_negoce($valeur) {
		$this->id_liaison_negoce = (int)$valeur;
		Outils::setAttributs('id_liaison_negoce',$this);
	}
	...
	public function setLotsNegoce($objets) {
		$this->lotsnegoce = $objets;
	}
