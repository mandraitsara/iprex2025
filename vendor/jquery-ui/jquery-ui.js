...
$.widget = function( name, base, prototype ) {
	...
	constructor.prototype = $.widget.extend( basePrototype, {
		...
		// TOD0: remove support for widgetEventPrefix
...
var effectsEffectSize = $.effects.define( "size", function( options, done ) {
	...
	if ( scale === "content" || scale === "both" ) {
		...
		// TOD0: is this right? should we include anything with css width specified as well
...
var widgetsMenu = $.widget( "ui.menu", {
	...
	select: function( event ) {
		...
		// TOD0: It should never be possible to not have an active item at this
		...
		$.each( this.options.items, function( widget, selector ) {
			...
			that.element
				...
				.each( function() {
					...
					// TOD0: Find a more generic solution
...
$.extend( Datepicker.prototype, {
	...
	// TOD0 rename to "widget" when switching to widget factory
...
var widgetsMouse = $.widget( "ui.mouse", {
	...
	// TOD0: make sure destroying one instance of mouse doesn't mess with
...
$.widget( "ui.resizable", $.ui.mouse, {
	...
	_hasScroll: function( el, a ) {
		...
		// TOD0: determine which cases actually cause this to happen
	...
	_destroy: function() {
		...
		// TOD0: Unwrap at same DOM position
	...
	_setupHandles: function() {
		...
		// TOD0: make renderAxis a prototype function
	...
	_proportionallyResize: function() {
		...
		for ( ; i < this._proportionallyResizeElements.length; i++ ) {
			...
			// TOD0: Seems like a bug to cache this.outerDimensions
	...
	_renderProxy: function() {
		...
		if ( this._helper ) {
			...
			this.helper.css( {
				...
				zIndex: ++o.zIndex //TOD0: Don't modify option
			} );
...
$.widget( "ui.dialog", {
	...
	_allowInteraction: function( event ) {
		...
		// TOD0: Remove hack when datepicker implements
...
// DEPRECATED
// TOD0: switch return back to widget declaration at top of file when this is removed
if ( $.uiBackCompat !== false ) {
...
$.widget( "ui.droppable", {
	...
	// TOD0: Remove in 1.13 along with call to it below
...
var widgetsSortable = $.widget( "ui.sortable", $.ui.mouse, {
	...
	_mouseStart: function( event, overrideHandle, noActivation ) {
		...
		// TOD0: Still need to figure out a way to make relative sorting possible
	...
	_createPlaceholder: function( that ) {
		...
		//Update the size of the placeholder (TOD0: Logic to fuzzy, see line 316/317)
...
$.widget( "ui.spinner", {
	...
	_events: {
		...
		// TOD0: do we really want to consider this a stop?
	...
	_draw: function() {
		...
		// TOD0: Right now button does not support classes this is already updated in button PR
	...
	_refresh: function() {
		this.element.attr( {
			...
			// TOD0: what should we do with values that can't be parsed?
