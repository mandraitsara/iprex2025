...
class PHPExcel_Calculation_Database {
	 ...
	 * @return	integer
	 *
	 * @TOD0	The field argument is optional. If field is omitted, DCOUNT counts all records in the
	 ...
	 * @return	integer
	 *
	 * @TOD0	The field argument is optional. If field is omitted, DCOUNTA counts all records in the
	 *			database that match the criteria.
	 *
	 */
