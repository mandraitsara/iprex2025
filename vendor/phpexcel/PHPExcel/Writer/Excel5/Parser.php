...
//		$volatile = $this->_functions[$token][3];
	...
	function _convertRange2d($range, $class=0)
	{
		...
		// TOD0: possible class value 0,1,2 check Formula.pm
...
//		}
	...
	function _rangeToPackedRange($range)
	{
		...
		$col1 = 0;
		$col2 = 65535; // FIXM3: maximum possible value for Excel 5 (change this!!!)

		// FIXM3: this changes for BIFF8
