...
function chargeEtape(numeroEtape, identifiant) {
    ...
    $.fn.ajax({
        ...
        'script_execute': 'fct_vue_sfr.php',
...
function listenerTicket() {
    ...
    // Déchargement des scans

    $('.btnDechargeScans').off("click.btnDechargeScans").on("click.btnDechargeScans", function(e) {
        e.preventDefault();
    ...
    $('.btnEditSelection').off("click.btnEditSelection'").on("click.btnEditSelection", function(e) {
        ...
        var ids = '';
        $('tbody .icheck:checked').each(function () {
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
function listenerEtape1(identifiant, skip_ticket) {
    "use strict";
    ...
    function checkSousSousTotal(objetDom) {
        ...
        $('.check-palette-'+id_palette).find('.icheck').iCheck(statut);
    ...
    function ticketNbSelectionnes() {
        ...
        var nbCheckLignes   = $('tbody .icheck:checked').length - check_sstotaux - check_sssstotaux;
...
/*
        ...
        if (id_clt === 0) { alert('ERREUR !\r\nIdentification du client impossible...');return false; }
        if (etape_suivante === 0) { alert('ERREUR !\r\nIdentification de l\'étape suivante impossible...');return false; }

        chargeEtape(etape_suivante, id_clt);
        return false;*/
    });
