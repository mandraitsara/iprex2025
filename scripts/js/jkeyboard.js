/**
 ------------------------------------------------------------------------
 JS - jKeybord - clavier virutel - optimisé pour IPEX
...
; (function ($, window, document, undefined) {
    ...
    var pluginName = "jkeyboard",
        defaults = {
            layout: "francais",
            selectable: ['azeri', 'english', 'german', 'francais'],
            input: $('#champ_clavier'),
            customLayouts: {
                selectable: []
            },
    ...
    var function_keys = {
        ...
        layout_switch: {
            text: '&nbsp;',
            command: function () {
                $('.masque-clavier-virtuel').show("slide" ,{ direction: "up"  });
    ...
    var shift = false, capslock = false, layout = 'francais', layout_id = 0;
    ...
    Plugin.prototype = {
        ...
        type: function (key) {
            ...
            var input_cbo = $('#champ_clavier').length ?  $('#champ_clavier') : this.settings.input;
